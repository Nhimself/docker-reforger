...
def steamcmd_install():
    ...
    if os.environ.get("STEAMAPPVALIDATE", "false").lower() != "true":
...
def generate_config():
    ...
    if os.environ["ARMA_CONFIG"] != "docker_generated":
        ...
        # If you dont provide an RCON password one will be generated for you
        if env_defined("RCON_ADDRESS") and env_defined("RCON_PORT"):
            if env_defined("RCON_PASSWORD"):
                ...
                rcon_password = random_passphrase()
                if os.environ.get("WRITE_AUTOGENERATED_PASSWORD_TO_LOG", "false").lower() != "true":
        ...
        if env_defined("GAME_MODS_JSON_FILE_PATH"):
            try:
                with open(os.environ["GAME_MODS_JSON_FILE_PATH"], 'r') as f:
            ...
            # Handling exceptions
                ...
                print(f"Mod file '{os.environ['GAME_MODS_JSON_FILE_PATH']}' not found.")
            except json.JSONDecodeError:
                print(f"Error decoding JSON in mod file: '{os.environ['GAME_MODS_JSON_FILE_PATH']}'.")
            except Exception as e:
                print(f"Error reading mod file '{os.environ['GAME_MODS_JSON_FILE_PATH']}': {e}")
